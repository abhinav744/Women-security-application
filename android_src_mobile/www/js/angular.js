...
/****************************************************************************/	
	...
	$http.post('http://10.0.2.2/projects/women_3/web/admin_details.php', {'email': $scope.bn_adm_email})
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/women_3/web/total_get.php')
...
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/women_3/web/project_get.php')
	.success(function (response) 
	{
		if(response.success == 1)
		{
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/women_3/web/sales_get.php')
	.success(function (response) 
	{
		if(response.success == 1)
		{
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/women_3/web/task_get.php')
	.success(function (response) 
	{
		if(response.success == 1)
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/confirm_sales.php', 
		{
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/women_3/web/products_get.php',{'status':$scope.status})
		.success(function (data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/women_3/web/products_add.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/products_delete.php', 
		{
...
$scope.product_update_data = function() 
	{
	$http.post('http://10.0.2.2/projects/women_3/web/products_update.php', {
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/sales_create.php', 
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/women_3/web/sales_update.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/sales_delete.php', 
		{
		'customer_id': customer_id
		})
		.success(function(data, status, headers, config) 
