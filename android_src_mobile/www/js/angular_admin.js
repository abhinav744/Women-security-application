...
/****************************************************************************/
	...
	{		
		$http.post('https://myapphosting.in/android/women_7/viewdetails.php', {
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/women_7/get_all_user.php')
	.success(function(data, status, headers, config) 
	{
			$scope.all_user_details = data.details;
    });
	
	$http.post('https://myapphosting.in/android/women_7/get_user_details.php', {'email':$scope.cook_user_email})
	.success(function(data, status, headers, config) 
	{
			$scope.view_user_details = data.details;
    });
	
	$http.post('https://myapphosting.in/android/women_7/get_all_gar.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/women_7/create_employee.php', 
		{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/women_7/create_category.php', 
		{
...
/****************************************************************************/
	...
	{
	$http.post('https://myapphosting.in/android/women_7/create_dept.php', 
		{
		'field_1':$scope.field_1
		})
		.success(function(data, status, headers, config) 
...
$scope.save_dept = function() 
	{
	$http.post('https://myapphosting.in/android/women_7/save_dept.php', {
...
$scope.save_cat = function() 
	{
	$http.post('https://myapphosting.in/android/women_7/save_cat.php', {
			'id': $scope.cook_cus_id,
			'field_1': $scope.cook_field_1})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{		
        $http.post('https://myapphosting.in/android/women_7/delete_dept.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
	...
	{		
        $http.post('https://myapphosting.in/android/women_7/delete_cat.php', 
		{
		'id': cusid
		})
		.success(function(data, status, headers, config) 
	...
	{		
        $http.post('https://myapphosting.in/android/women_7/delete_details.php', 
		{
		'id': cus_id
		})
		.success(function(data, status, headers, config) 
	...
	$http.post('https://myapphosting.in/android/women_7/get_employee.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	$http.post('https://myapphosting.in/android/women_7/get_employee_info.php', 
		{
...
$scope.save_employee = function() 
	{
	$http.post('https://myapphosting.in/android/women_7/save_employee.php', {
	...
	$http.post('https://myapphosting.in/android/women_7/get_all_results.php')
		.success(function(data, status, headers, config) 
		{
	...
	$http.post('https://myapphosting.in/android/women_7/get_site_results.php')
	.success(function(data, status, headers, config) 
	{
