...
/****************************************************************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/user_logout.php',{'email':$scope.cook_user_email})
	...
	$http.post('http://10.0.2.2/projects/women_3/web/get_dept.php')
	.success(function(data, status, headers, config) 
	{
	...
	$http.post('http://10.0.2.2/projects/women_3/web/get_category.php')
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	$scope.create_grievance = function() 
	{
		...
		$http.post('http://10.0.2.2/projects/women_3/web/create_grievance.php', 
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/create_site.php', {
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/create_block.php', {
...
/************************** User View Complaint *********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/women_3/web/get_block.php')
	.success(function(data, status, headers, config) 
	{
			$scope.block_details = data.details;
    });
	
	$http.post('http://10.0.2.2/projects/women_3/web/get_user.php', {'email': $scope.cook_user_email} )
	.success(function(data, status, headers, config) 
	{
...
/************************** Add Requirment ***********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/women_3/web/viewdetails.php', {'email': $scope.cook_user_email})
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/delete_site.php', 
		{
		'id': id
		})
		.success(function(data, status, headers, config) 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/view_site.php', 
		{
		'field_3': field_3
		})
		.success(function(data, status, headers, config) 
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/send_mail.php', 
		{
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/send_sms.php', 
		{
...
$scope.update_details = function(cus_id,field_1,field_2,field_3) 
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/save_details.php',{
	...
	$http.post('http://10.0.2.2/projects/women_3/web/get_user_grievance.php', 
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/save_rating.php',{
	...
	$http.post('http://10.0.2.2/projects/women_3/web/get_user_redressal.php', 
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/update_grievance.php',{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/delay_grievance.php',{
		...
		$http.post('http://10.0.2.2/projects/women_3/web/get_user_info.php',
		{
			'email':$scope.cook_user_email
		})
		.success(function(data, status, headers, config) 
...
$scope.user_update_info = function(name,password,mobile) 
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/user_update_info.php',{
