...
/****************************************************************************/
	...
	{		
        ...
        $http.post('http://10.0.2.2/projects/women_3/web/user_login.php', 
			{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/police_login.php', 
			{'email': $scope.email, 'password':$scope.password})
		.success(function(data, status, headers, config) 
		{
...
//************************** admin_register **********************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/user_register.php',{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/admin_login.php', 
			{'email': $scope.email, 'password':$scope.password})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
//************************** admin_register **********************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/admin_register.php',{
...
/************************** Update Admin Info **********************************/
		...
		$http.post('http://10.0.2.2/projects/women_3/web/get_admin_info.php')
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{			
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/women_3/web/admin_update.php',{
		 'name':$scope.name,'email':$scope.email,
		 'password':$scope.password,'mobile': $scope.mobile})
		.success(function(data, status, headers, config) 
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/women_3/web/newpassword.php', 
			{	'email': $scope.email, 'password':$scope.password,
				'field_3': $scope.field_3, 'field_4':$scope.field_4
				})
		.success(function(data, status, headers, config) 
